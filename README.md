...
Three sibling apps: `frontend/` (public storefront, Vite/React), `backend-php/` (PHP API), `admin/` (Vite/React admin panel for managing the machine catalog).
...
See `frontend/README.md` for the storefront's scripts and import conventions.
